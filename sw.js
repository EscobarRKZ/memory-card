const CACHE='memory-card-v20-catalog-fix';
const COVER_CACHE='memory-card-covers-v6';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./cover-fixes.css','./ui-enhancements.css','./title-search-helper.js','./switch-cover-helper.js','./ui-enhancements.js','./catalog-refresh-helper.js','./app.js','./manifest.webmanifest','./icon.svg','./logo-192.png','./logo-512.png','./logo.png'];
