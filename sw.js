const CACHE='memory-card-v32-product-v14';
const COVER_CACHE='memory-card-covers-v14';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./cover-fixes.css','./ui-enhancements.css','./profile-social.css','./product-v13.css','./product-v14.css','./title-search-helper.js','./switch-cover-helper.js','./ps3-cover-helper.js','./ps3-wikipedia-cover-helper.js','./ui-enhancements.js','./catalog-refresh-helper.js','./cover-refresh-helper.js','./modal-draft-helper.js','./app.js','./profile-core.js','./friends.js','./product-v13.js','./product-v14.js','./manifest.webmanifest','./icon.svg','./logo-192.png','./logo-512.png','./logo.png'];
