const CACHE='memory-card-v16-platform-sort';
const COVER_CACHE='memory-card-covers-v6';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./cover-fixes.css','./ui-enhancements.css','./autosync-helper.js','./title-search-helper.js','./switch-cover-helper.js','./ui-enhancements.js','./app.js','./manifest.webmanifest','./icon.svg','./logo-192.png','./logo-512.png','./logo.png'];
