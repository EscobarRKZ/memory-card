const CACHE='memory-card-v12-mobile';
const COVER_CACHE='memory-card-covers-v5';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./app.js','./manifest.webmanifest','./icon.svg','./logo-192.png','./logo-512.png','./logo.png'];
